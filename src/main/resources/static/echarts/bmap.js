    ...
    return function (t) {
        ...
        n = function (t) {
            ...
            e.prototype.dimensions = ["lng", "lat"], e.prototype.setZoom = function (t) {
                ...
                var e = this._mapOffset, t = this._bmap.overlayPixelToPoint({x: t[0] + e[0], y: t[1] + e[1]});
                return [t.lng, t.lat]
                ...
                return {
                    ...
                    api: {coord: a.bind(this.dataToPoint, this), size: a.bind(n, this)}
                }
            };
            var p;
            return e.dimensions = e.prototype.dimensions, e.create = function (t, o) {
                ...
                t.eachComponent("bmap", function (t) {
                    var a = o.getZr().painter.getViewportRoot();
                    ...
                    if (!t.__bmap) {
                        ...
                        s && (a.style.left = "0px", a.style.top = "0px", i.removeChild(s)), s = document.createElement("div"), s.style.cssText = "width:100%;height:100%", s.classList.add("ec-extension-bmap"), i.appendChild(s);
                        var c = t.__bmap = new BMap.Map(s), m = new p(a);
                        c.addOverlay(m)
                    }
                    var c = t.__bmap, d = t.get("center"), l = t.get("zoom");
                    if (d && l) {
                        var f = new BMap.Point(d[0], d[1]);
                        c.centerAndZoom(f, l)
                    }
                    n = new e(c, o), n.setMapOffset(t.__mapOffset || [0, 0]), n.setZoom(l), n.setCenter(d), t.coordinateSystem = n
        ...
        n = function (t) {
            return o(1).extendComponentView({
                type: "bmap", render: function (t, e, o) {
                    ...
                    var r = !0, i = t.getBMap(), a = o.getZr().painter.getViewportRoot(), p = t.coordinateSystem, s = function (e, n) {
                        if (!r) {
                    ...
                    var m = t.__mapStyle, d = t.get("mapStyle") || {}, l = JSON.stringify(d);
                    JSON.stringify(m) !== l && (Object.keys(d).length && i.setMapStyle(d), t.__mapStyle = JSON.parse(l)), r = !1
                }
            })
        }.call(e, o, e, t), !(void 0 !== n && (t.exports = n))
    }])
