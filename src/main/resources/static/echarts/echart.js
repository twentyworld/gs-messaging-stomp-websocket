/**
 * Created by wanglingna on 17/8/11.
 */
$(document).ready(function(){
    var height = window.screen.height;

    var candlestick = document.getElementById('contain');
    //var kk =$("#contain>:first")
    candlestick.style.height = height-385 + "px";
    //kk.style.height = height-300 + "px";
    //alert(candlestick.style.height);
    var dom = document.getElementById("contain");
    var myChart = echarts.init(dom);
    var app = {};
    option = null;
    app.title = '2017 年上证指数';
